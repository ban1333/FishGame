...
namespace FinalProjectShell
{
    ...
    public class Game1 : Game
    {
        ...
        public Game1()
        {
            ...
            graphics.PreferredBackBufferWidth = (int)BackgroundMeasurements.width;
            graphics.PreferredBackBufferHeight = (int)BackgroundMeasurements.height;
